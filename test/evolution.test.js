...
(async () => {
  ...
  // ---- Cliente salva configuração da instância (sem chamar a Evolution) ----
  ...
  console.log('[ok] salvar configuração da instância');

  // ---- Status: Evolution não configurada => configured=false, instância presente ----
